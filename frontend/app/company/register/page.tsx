    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "#f8fafc" }}>
      ...
      >
        ...
        <Button
          ...
          variant="outlined"
          size="small"
          sx={{ borderColor: "#cbd5e1", color: "text.primary", fontSize: "0.8rem" }}
        >
          Sign In
        </Button>
      </Box>
      ...
      >
        {/* Page Header */}
        <Box sx={{ textAlign: "center", mb: 4, maxWidth: 560 }}>
          <Typography
            variant="overline"
          ...
          <Typography variant="h3" fontWeight={700} mt={0.75} mb={1} sx={{ fontSize: { xs: "1.5rem", sm: "1.9rem" } }}>
            Company Registration
          </Typography>
          <Typography variant="body2" color="text.secondary">
            Create your recruiter account to access and submit Job & Internship Notification Forms.
          </Typography>
        </Box>
        ...
        {success && (
          <Box sx={{ width: "100%", maxWidth: 600, mb: 2 }}>
            <Alert severity="success" icon={<CheckCircleIcon />}>{success}</Alert>
          </Box>
        )}
        {error && (
          <Box sx={{ width: "100%", maxWidth: 600, mb: 2 }}>
        ...
        >
          {/* Step label */}
          <Typography variant="overline" color="primary.main" fontWeight={700} fontSize="0.68rem" letterSpacing="0.08em">
            Step {activeStep + 1} of {steps.length}
          </Typography>
          <Typography variant="h5" fontWeight={700} mt={0.5} mb={3} sx={{ fontSize: { xs: "1.1rem", sm: "1.25rem" } }}>
            {steps[activeStep]}
          </Typography>
          ...
          <Box component="form" noValidate onSubmit={handleSubmit(onSubmit)}>
            ...
            {activeStep === 1 && (
              <Stack spacing={3}>
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start"><ApartmentIcon color="action" /></InputAdornment>
                    ),
                  }}
                />
                ...
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start"><LanguageIcon color="action" /></InputAdornment>
                    ),
                  }}
                />
                ...
                >
                  {logoFiles && logoFiles.length > 0
                    ...
                    : "Upload Company Logo"}
                  <input hidden type="file" accept=".jpg,.jpeg,.png,.webp,.svg" {...register("company_logo")} />
                </Button>
                {errors.company_logo && (
                  <Typography variant="caption" color="error">{errors.company_logo.message as string}</Typography>
                )}
              </Stack>
            )}
            ...
            {activeStep === 2 && (
              <Stack spacing={3}>
                ...
                <Stack spacing={2.5}>
                  <Card variant="outlined" sx={{ borderRadius: "10px", overflow: "hidden" }}>
                    <Box sx={{ bgcolor: "primary.main", color: "primary.contrastText", px: 2.5, py: 1.5 }}>
                      <Typography variant="subtitle1" fontWeight={700}>Head Talent Acquisition</Typography>
                    </Box>
                    <CardContent>
                  ...
                  <Card variant="outlined" sx={{ borderRadius: "10px", overflow: "hidden" }}>
                    <Box sx={{ bgcolor: "#334155", color: "common.white", px: 2.5, py: 1.5 }}>
                      <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={2}>
                        <Typography variant="subtitle1" fontWeight={700}>Primary Contact (PoC 1)</Typography>
                        <Button
                          size="small"
                          variant="outlined"
                          color="inherit"
                          ...
                          sx={{ borderColor: "rgba(255,255,255,0.4)", fontSize: "0.75rem" }}
                        >
                          Edit
                        </Button>
                      </Stack>
                    ...
                    <CardContent>
                      <Grid2 container spacing={2}>
                        ...
                        <Grid2 size={{ xs: 12, md: 6 }}>
                          <TextField label="Mobile Number" fullWidth value={recruiterMobile || ""} disabled />
                        </Grid2>
                        <Grid2 size={{ xs: 12, md: 6 }}>
                  ...
                  <Card variant="outlined" sx={{ borderRadius: "10px", overflow: "hidden" }}>
                    <Box sx={{ bgcolor: "#64748b", color: "common.white", px: 2.5, py: 1.5 }}>
                      <Typography variant="subtitle1" fontWeight={700}>Secondary Contact (PoC 2) — Optional</Typography>
                    </Box>
                    <CardContent>
                      <Grid2 container spacing={2}>
                        <Grid2 size={{ xs: 12, md: 6 }}>
            ...
            <Stack direction="row" spacing={2} sx={{ mt: 4 }}>
              {activeStep > 0 && (
                <Button
                  ...
                  sx={{ borderColor: "#cbd5e1", color: "text.primary" }}
                >
                  Back
                </Button>
              )}
          ...
          {/* Sign in link */}
          <Box sx={{ display: "flex", alignItems: "center", my: 3.5, gap: 2 }}>
          ...
          <Button
            ...
            size="large"
            fullWidth
            sx={{ borderColor: "#cbd5e1", color: "text.primary", fontWeight: 600, py: 1.3, "&:hover": { borderColor: "primary.main", color: "primary.main" } }}
          >
            Sign In Instead
          </Button>
        </Box>

        <Typography variant="caption" color="text.secondary" sx={{ mt: 4, mb: 2, opacity: 0.6 }}>
      ...
      <Dialog open={emailVerificationRequested} onClose={() => setEmailVerificationRequested(false)}>
        ...
        <DialogActions>
          <Button onClick={() => setEmailVerificationRequested(false)} autoFocus>OK</Button>
        </DialogActions>
      </Dialog>
    </Box>
  );
